...
public class VerifyAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            query = "select count(*) from admin where username='" + uname + "' and pswd='" + pswd + "'";
            ...
            {
                pw.println("<script type=text/javascript>alert('Invalid Username or Password!');location.replace('admin/AdminLogin.jsp');</script>");
            }
